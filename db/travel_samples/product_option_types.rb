...
ror_baseball_jersey = Spree::ProductHotel.find_by_name!("Ruby on Rails Baseball Jersey")
ror_baseball_jersey.option_types = [size, color]
ror_baseball_jersey.save!

spree_baseball_jersey = Spree::ProductHotel.find_by_name!("Spree Baseball Jersey")
